        ...
        return (
          <div className={`product ${classNames(className)}`}>
            <div className="product-img">
              {!redirect && round ? (
                <Link
                  ...
                  as={
                    process.env.PUBLIC_URL + `/shop/cart`
                  }
                >
                  <a title={data?.facility?.name}>
                    <img
                      // src="/assets/images/sections/introduction/33.jpeg"
                      src={data?.coverImage} 
                      alt="Product image"
                    />
                  </a>
            ...
            <div className="product-content">
              ...
              <Link
                href={process.env.PUBLIC_URL + `/shedule/[slug]`}
                as={process.env.PUBLIC_URL + `/shedule/${data?.facility?.mid}`}
              >
                <a
            ...
            {round ? null : (
              <div className="product-select">
                <Tooltip title="Add to wishlist">
                  <Button
                    onClick={() => onAddWishlist(data?.facility)}
                    className={`product-btn ${classNames({
                      active: productInWishlist,
                    })}`}
                    type="primary"
                ...
                <Tooltip title="Add to cart">
                  <Button
                    onClick={() => onAddToCart(data?.facility)}
                    className="product-btn"
                    type="primary"
                    shape="round"
                    icon={
                ...
                <Tooltip title="Add to compare">
                  <Button
                    onClick={() => onAddToCompare(data?.facility)}
                    className={`product-btn ${classNames({
                      active: productInCompare,
                    })}`}
                    type="primary"
