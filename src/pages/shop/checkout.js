              ...
              <Row gutter={50}>
                <Col xs={24} md={16}>
                  <div className="checkout-form">
                    <h3 className="checkout-title text-white">Billing details</h3>
                    <Form
                      name="checkout"
                      layout="vertical"
                      onFinish={onFinish}
                ...
                <Col xs={24} md={8}>
                  <div className="checkout-total">
                    <h3 className="checkout-title text-white">Your order</h3>
                    <table className="checkout-total__table">
                      <tbody>
                        ...
                        <tr>
                          <th className="text-white">Extra</th>
                          <td>
                            <p className="text-white">Rest Room</p>
